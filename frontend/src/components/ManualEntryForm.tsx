...
export const ManualEntryForm = () => {
  ...
  const bcvToUse = dailyBcvRate || Number(useAppStore.getState().bcvRate) || 36.5;
  ...
  // Cargar métodos de pago y tasa BCV diaria
  useEffect(() => {
    ...
    <Box component="form" onSubmit={handleSubmit}>
      ...
      >
        ...
        <Typography variant="body2" sx={{ color: '#94a3b8', mt: 1 }}>
          Para registrar transacciones sin facturas asociadas (soporte técnico, instalaciones, etc.)
        </Typography>
      </Paper>
      ...
      >
        ...
        <Stack spacing={2}>
          <FormControl fullWidth>
            <InputLabel sx={{ color: '#94a3b8' }}>Tipo de Registro</InputLabel>
            <Select 
              value={invoiceType} 
          ...
          <TextField 
            ...
            value={invoiceBaseUSD} 
            onChange={(e) => setInvoiceBaseUSD(e.target.value)} 
            required
          ...
          <TextField 
            ...
            placeholder="Descripción del servicio, observaciones..."
            sx={{
              '& .MuiInputBase-root': {
                backgroundColor: '#0f172a',
                color: '#fff'
      ...
      >
        {loadingSubmit ? <CircularProgress size={24} sx={{ color: '#64748b' }} /> : 'Guardar Registro Manual'}
      </Button>
